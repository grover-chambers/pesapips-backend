...
const C = { mono:"mono", sans:"sans", display:"display", surface:"s", surface2:"s2", border:"b", gold:"g", green:"gr", red:"r", text:"t", text2:"t2", text3:"t3", blue:"bl", greenDim:"gd", redDim:"rd", goldDim:"gold" }
function StatCard(p){return <div/>}
function SectionHeader(p){return <div/>}
function TierGate(p){return <div/>}
function canAccess(a,b){return true}
const api = {get:()=>{},post:()=>{}}
