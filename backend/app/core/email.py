...
def email_password_reset(to: str, name: str, reset_link: str) -> bool:
    html = _wrap(f"""
    <h2>Your password has been reset</h2>
    <p>An admin has reset your PesaPips password. Click the link below to set your new password.</p>
    <p><a href="{reset_link}" class="btn">Set New Password →</a></p>
    <p>This link expires in 24 hours. If you didn't request this, contact support immediately.</p>
    """)
    return send_email(to, "Reset your PesaPips password", html)
